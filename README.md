...
If you have Java, once you download the barracks.jar file, that's already enough to use it, just launch it through the terminal/cmd by doing "java -jar barracks.jar" in the folder with barracks.jar in.
